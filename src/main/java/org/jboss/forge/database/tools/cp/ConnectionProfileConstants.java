...
public interface ConnectionProfileConstants {

	final String NAME = "name";
	final String NAME_HELP = "Name for this connection profile.";

	final String TYPE = "type";
	final String TYPE_HELP = "Predefined connection profile type to use.";

	final String DIALECT = "dialect";
	final String DIALECT_HELP = "Dialect to use for the connection profile.";
	final String DIALECT_PROMPT = "Enter the dialect to use for the connection profile.";
	final String DIALECT_DEFAULT = "org.hibernate.dialect.H2Dialect";

	final String DRIVER = "driver";
	final String DRIVER_HELP = "Class name for the JDBC driver for the connection profile.";
	final String DRIVER_PROMPT = "Specify the class name for the JDBC driver for the connection profile.";
	...
	final String URL_DEFAULT = "jdbc:h2:tcp://localhost/default";
